        ...
        <div className="relative mx-auto grid max-w-7xl items-center gap-14 lg:grid-cols-[1.05fr_0.95fr] lg:gap-20">
          <motion.div {...fadeInUp}>
            <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-[#2f855a]/20 bg-white/70 px-3 py-1.5 text-xs font-semibold uppercase tracking-[0.18em] text-[#2f855a]">
              <span className="h-1.5 w-1.5 rounded-full bg-[#2f855a]" />A clearer way forward
            </div>
            <h1 className="max-w-3xl text-5xl font-semibold leading-[0.98] tracking-[-0.05em] sm:text-6xl lg:text-7xl">
              From a question to a confident{' '}
              <span className="font-serif italic text-[#2f855a]">next step.</span>
            </h1>
            <p className="mt-7 max-w-xl text-lg leading-8 text-[#173b2b]/65 sm:text-xl">
              IP-SAKTI turns complex Ayurveda IP and regulatory questions into a guided,
              source-backed process your team can actually follow.
            </p>
            <div className="mt-9 flex flex-wrap items-center gap-4 text-sm font-semibold">
              <a
                href="#process"
                className="group inline-flex items-center gap-3 rounded-full bg-[#2f855a] px-5 py-3 text-white shadow-lg shadow-[#2f855a]/15 transition-transform hover:-translate-y-0.5"
              >
                See the four steps
          ...
          >
            ...
            <div className="relative overflow-hidden rounded-[1.6rem] border border-[#173b2b]/10 bg-white p-5 shadow-[0_24px_80px_rgba(23,59,43,0.12)] sm:p-7">
              <div className="flex items-center justify-between border-b border-[#173b2b]/10 pb-5">
                <div>
                  <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-[#2f855a]">
                    Live guidance flow
                  </p>
                  <p className="mt-1 text-lg font-semibold">Your question, mapped.</p>
                </div>
                <div className="flex gap-1.5">
                  <span className="h-2 w-2 rounded-full bg-[#f1b05d]" />
                  <span className="h-2 w-2 rounded-full bg-[#7ac48b]" />
                  <span className="h-2 w-2 rounded-full bg-[#b9d7c0]" />
                </div>
              </div>
              <div className="space-y-3 py-6">
                <div className="rounded-2xl bg-[#f4f8f4] p-4">
                  <div className="flex items-start gap-3">
                    <div className="rounded-xl bg-white p-2 text-[#2f855a] shadow-sm">
                      <FileText className="h-4 w-4" />
                    </div>
                    <div>
                      <p className="text-xs font-semibold text-[#173b2b]/45">YOUR QUESTION</p>
                      <p className="mt-1 text-sm font-medium leading-6">
                        Can this classical formulation be protected in a new market?
                      </p>
                    </div>
                  </div>
                </div>
                <div className="flex justify-center">
                  <ArrowDown className="h-4 w-4 text-[#2f855a]" />
                </div>
                <div className="grid grid-cols-2 gap-3">
                  <div className="rounded-2xl border border-[#173b2b]/10 p-4">
                    <Database className="h-4 w-4 text-[#c26726]" />
                    <p className="mt-3 text-xs font-semibold text-[#173b2b]/45">SOURCES</p>
                    <p className="mt-1 text-sm font-semibold">14 records found</p>
                  </div>
                  <div className="rounded-2xl border border-[#173b2b]/10 p-4">
                    <Languages className="h-4 w-4 text-[#6d5aa7]" />
                    <p className="mt-3 text-xs font-semibold text-[#173b2b]/45">CONTEXT</p>
                    <p className="mt-1 text-sm font-semibold">Ayurveda + IP</p>
                  </div>
                </div>
                <div className="rounded-2xl bg-[#173b2b] p-4 text-white">
                  <div className="flex items-center justify-between">
                    <p className="text-xs font-semibold uppercase tracking-[0.16em] text-[#b7dfbf]">
                      Recommended direction
                    </p>
                    <Check className="h-4 w-4 text-[#b7dfbf]" />
                  </div>
                  <p className="mt-2 text-sm leading-6 text-white/80">
                    Review novelty, market-specific requirements, and evidence before filing.
                  </p>
                </div>
              </div>
              <div className="flex items-center gap-2 border-t border-[#173b2b]/10 pt-5 text-xs text-[#173b2b]/50">
                <LockKeyhole className="h-3.5 w-3.5" /> Source-cited. Secure. Designed for
                decisions.
              </div>
            </div>
          </motion.div>
        ...
        <div className="mx-auto max-w-7xl">
          <motion.div {...fadeInUp} className="mb-14 max-w-2xl lg:mb-20">
            ...
            <h2 className="mt-4 text-4xl font-semibold tracking-[-0.04em] sm:text-5xl">
              ...
              <br />
              <span className="font-serif italic text-[#2f855a]">Serious underneath.</span>
            </h2>
            <p className="mt-5 text-lg leading-8 text-[#173b2b]/60">
              Each step removes guesswork while keeping the evidence visible, so you can move from
              exploration to action with clarity.
            </p>
          </motion.div>
            ...
            {steps.map((step, i) => {
              ...
              return (
                <motion.article
                  ...
                  className="relative flex flex-col rounded-[1.35rem] border border-[#173b2b]/10 bg-white p-6 shadow-[0_10px_30px_rgba(23,59,43,0.05)] transition-all hover:-translate-y-1 hover:shadow-[0_18px_40px_rgba(23,59,43,0.1)] lg:min-h-[390px]"
                >
                  <div className="relative z-10 flex items-center justify-between">
                    ...
                    <span className="text-5xl font-semibold tracking-[-0.08em] text-[#173b2b]/10">
                      {step.number}
                    </span>
                  </div>
                  <p className="mt-8 text-xs font-bold uppercase tracking-[0.16em] text-[#2f855a]">
                    {step.kicker}
                  </p>
                  ...
                  <ul className="mt-auto space-y-2 border-t border-[#173b2b]/10 pt-5">
                    {step.details.map((detail) => (
                      <li
                        key={detail}
                        className="flex items-center gap-2 text-xs font-medium text-[#173b2b]/65"
                      >
      ...
      <section className="border-y border-[#173b2b]/10 bg-[#edf6ef] px-4 py-16 sm:px-6 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-8 sm:grid-cols-3 sm:gap-0">
          {[
            ...
            <div
              key={label}
              className={`text-center ${i > 0 ? 'border-t border-[#173b2b]/10 pt-8 sm:border-l sm:border-t-0 sm:pt-0' : ''}`}
            >
              <p className="text-5xl font-semibold tracking-[-0.06em] text-[#2f855a]">{value}</p>
              <p className="mt-2 text-sm text-[#173b2b]/55">{label}</p>
            </div>
          ))}
        </div>
      </section>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            {faqs.map((faq, i) => (
              <motion.div
                ...
                className="rounded-2xl border border-[#173b2b]/10 bg-white p-6"
              >
                <h3 className="text-base font-semibold leading-6">{faq.q}</h3>
                <p className="mt-3 text-sm leading-6 text-[#173b2b]/60">{faq.a}</p>
              </motion.div>
            ))}
          </div>
          <motion.div
            {...fadeInUp}
            className="mt-12 flex flex-col items-center justify-between gap-5 rounded-3xl bg-[#173b2b] p-8 text-center text-white sm:flex-row sm:p-10 sm:text-left"
          >
            <div>
            ...
            <a
              href="/chat"
              className="group inline-flex shrink-0 items-center gap-3 rounded-full bg-[#b7dfbf] px-5 py-3 text-sm font-bold text-[#173b2b] transition-transform hover:-translate-y-0.5"
            >
