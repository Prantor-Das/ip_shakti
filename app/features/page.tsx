      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-8">
        <motion.div {...fadeInUp} className="text-center max-w-3xl mx-auto">
          ...
          <p className="text-lg sm:text-xl text-gray-400 leading-relaxed">
            From natural language AI assistance to TKDL prior-art assessment and classical Ayurveda
            Samhita repositories—explore everything IP-SAKTI offers.
          </p>
        </motion.div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 border-t border-white/10">
        <motion.div {...fadeInUp} className="text-center mb-16">
          ...
          <p className="text-gray-400 text-lg max-w-2xl mx-auto">
            Empowering Ayurvedic heritage through precision IP guidance for every stakeholder
          </p>
        </motion.div>
            ...
            <motion.div {...fadeInUp} className="space-y-8">
              <div>
                ...
                <p className="text-xl text-gray-300 leading-relaxed">
                  From Vaidyas documenting formulations to pharma companies navigating global
                  regulations—IP-SAKTI gives you confidence in every step.
                </p>
              </div>
                ...
                {[
                  {
                    ...
                    desc: 'Get instant patentability insights',
                  },
                  {
                    icon: '✓',
                    title: 'TKDL context',
                  ...
                  },
                  {
                    ...
                    desc: 'Access guidance in your language',
                  },
                  {
                    icon: '✓',
            ...
            <motion.div {...fadeInUp} className="space-y-6">
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-gray-300 mb-6">
                    Get instant answers on patentability, compliance, and IP protection strategies
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-gray-300 mb-6">
                    Dive into classical Ayurvedic formulations, historical references, and IP
                    protection guidelines in one place.
                  </p>
                  <Link
                    href="/samhita"
                    className="inline-flex items-center gap-2 px-6 py-3 bg-primary text-primary-foreground font-semibold rounded-lg hover:bg-primary/90 transition-all duration-300 group-hover:gap-3"
